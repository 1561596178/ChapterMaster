...
function scr_draw_management_unit(selected, yy = 0, xx = 0, draw = true, click_lock = false) {
    ...
    if (draw && !impossible && ma_view[selected]) {
        ...
        // Draw the name
        draw_set_color(c_gray);
        draw_text_transformed(xx + 27 + 8, yy + 63, string_hash_to_newline(string(string_role)), name_xr, 1, 0);
        draw_text_transformed(xx + 27.5 + 8, yy + 63.5, string_hash_to_newline(string(string_role)), name_xr, 1, 0);
        ...
        draw_text(xx + 430 + 8, yy + 63, truncatedLocation); // LOC
        draw_set_alpha(1);

        if (ma_loc[selected] == "Mechanicus Vessel") {
            draw_sprite(spr_loc_icon, 2, xx + 427 + 8, yy + 63);
        } else {
            if (man[selected] == "man") {
                _unit = display_unit[selected];

                if ((ma_lid[selected] > -1) && (ma_wid[selected] == 0)) {
                    draw_sprite(spr_loc_icon, _unit.is_boarder ? 2 : 1, xx + 427 + 8, yy + 63);
                } else if (ma_wid[selected] > 0) {
                    draw_sprite(spr_loc_icon, 0, xx + 427 + 8, yy + 63);
                }
            } else {
                if ((ma_lid[selected] == -1) && (ma_wid[selected] > 0)) {
                    draw_sprite(spr_loc_icon, 0, xx + 427 + 8, yy + 63);
                ...
                if ((ma_lid[selected] > -1) && (ma_wid[selected] == 0)) {
                    draw_sprite(spr_loc_icon, 1, xx + 427 + 8, yy + 63);
                }
            }
        }
        //TODO handle recursively
        if (man[selected] == "man") {
            ...
            draw_text(xx + 573, yy + 63, string_hash_to_newline(string(ma_ar)));
            ...
            draw_text(xx + 573 + xoffset, yy + 63, string_hash_to_newline(string(ma_mb)));
            ...
            draw_text(xx + 573 + xoffset, yy + 63, string_hash_to_newline(string(ma_ge)));
            ...
            draw_text(xx + 573 + xoffset, yy + 63, string_hash_to_newline(string(ma_we1)));
            ...
            draw_text(xx + 573 + xoffset, yy + 63, string_hash_to_newline(string(ma_we2)));
            xoffset += 100;

            if (array_length(_unit.manage_tags)) {
                var _tag_button = draw_unit_buttons([xx + 573 + xoffset, yy + 63], "T");
        ...
        if (man[selected] != "man") {
            ...
            draw_text(xx + 573, yy + 63, string_hash_to_newline(string(ma_ge)));
            ...
            draw_text(xx + 573 + xoffset, yy + 63, string_hash_to_newline(string(ma_ar)));
        }
    }
