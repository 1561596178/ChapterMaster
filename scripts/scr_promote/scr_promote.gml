...
function draw_popup_promotion() {
    ...
    draw_text(1292, 150, L("Promoting"));
    ...
    draw_text(1292, 175, LF("{0} Company {1}", [comp, unit_role]));
    ...
    draw_text(1020, 290, L("Target Role:")); //choose new role
    var role_x = 0;
    role_y = 0;
    if (target_comp != -1) {
        for (var r = 1, l = array_length(role_name); r < l; r++) {
            if (role_name[r] != "") {
                ...
                draw_text(1030 + role_x, 310 + role_y, LF("{0} [{1}]", [role_name[r], check]));
    ...
    draw_text(1020, 370, string_hash_to_newline(L("Required Gear:")));
    var gr = 0, tox = "";
    ...
    if (target_role > 0) {
        if (req_armour != "") {
            ...
            draw_text(1030, 390, LF("{0} {1} (Have {2})", [req_armour_num, req_armour, have_armour_num]));
        }
        if (req_gear != "") {
            ...
            draw_text(1030, 410, LF("{0} {1} (Have {2})", [req_gear_num, req_gear, have_gear_num]));
        }
        if (req_mobi != "") {
            ...
            draw_text(1030, 430, LF("{0} {1} (Have {2})", [req_mobi_num, req_mobi, have_mobi_num]));
        }
        if (req_wep1 != "") {
            ...
            draw_text(1280, 390, LF("{0} {1} (Have {2})", [req_wep1_num, req_wep1, have_wep1_num]));
        }
        if (req_wep2 != "") {
            ...
            draw_text(1280, 410, LF("{0} {1} (Have {2})", [req_wep2_num, req_wep2, have_wep2_num]));
        }
    }
