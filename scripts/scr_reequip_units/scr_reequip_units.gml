...
function set_up_equip_popup() {
    static setup_UI_elements = function() {
        ...
        if (unchangeable_armour) {
            ...
            armour_select.tooltip = L("One or more Marine has Dreadnought armour and cannot be changed");
...
function draw_popup_equip() {
    ...
    draw_text(1302, 150, L("Change Equipment"));
    ...
    draw_text(1292, 175, LF("{0} Company, {1} {2}", [comp, unit_count, L(_descriptor)]));
    ...
    draw_text_outline(1020, 195, L("Before"));
    ...
    for (var i = 0; i < STANDARD_EQUIP_SLOT_COUNT; i++) {
        ...
        draw_text(1024, 215 + (i * 20), L(_current));
    }

    draw_text_outline(1296, 195, L("After"));
