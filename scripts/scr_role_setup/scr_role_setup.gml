...
function role_setup_objects() {
    specialist_distribution_box = new ToggleButton({
        ...
        x1: 500,
        y1: 250,
        tooltip: LF("Specialist Distribution\nCheck if you wish for your Companies to be uniform and each contain {0} and {1}.", [L(role[100][10]), L(role[100][9])]),
...
function scr_role_setup() {
    ...
    draw_text_color_simple(800, 80, L("Roles"), CM_GREEN_COLOR);
    var c = 100;
    ...
    if (!instance_exists(obj_creation_popup)) {
        ...
        if (scr_hit(540, 547, 800, 725)) {
            tooltip = L("Advisor Names");
            tooltip2 = L("The names of your main Advisors.  They provide useful information and reports on the divisions of your Chapter.");
        }

        draw_text_transformed(444, 550, string_hash_to_newline(L("Advisor Names")), 0.6, 0.6, 0);
        draw_set_font(fnt_40k_14b);
        draw_set_halign(fa_right);
        if (race[100][15] != 0) {
            draw_text(594, 575, L("Chief Apothecary: "));
        }
        if (race[100][14] != 0) {
            draw_text(594, 597, L("High Chaplain: "));
        }
        if (race[100][17] != 0) {
            draw_text(594, 619, L("Chief Librarian: "));
        }
        if (race[100][16] != 0) {
            draw_text(594, 641, L("Forge Master: "));
        }
        draw_text(594, 663, L("Master of Recruits: "));
        draw_text(594, 685, L("Master of the Fleet: "));
        draw_set_halign(fa_left);
