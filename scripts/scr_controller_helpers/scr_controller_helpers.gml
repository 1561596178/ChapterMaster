...
function init_manage_buttons() {
    management_buttons = {
        ...
        bio_toggle: new UnitButtonObject({
            style: "pixel",
            label: L("Show Bio"),
            tooltip: L("Click here or press B to Toggle Unit Biography."),
        }),
        capture_image: new UnitButtonObject({
            style: "pixel",
            label: L("Capture Image"),
            tooltip: L("Click to create a local png of the given marine in the game folder."),
        }),
