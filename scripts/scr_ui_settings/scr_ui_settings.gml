...
function setup_ui_chapter_settings() {
    ...
    for (var i = 0; i < array_length(_role_order); i++) {
        ...
        var _role_label = L(obj_ini.role[100][_role_id]);
        var _button = new UnitButtonObject({
            ...
            active: _active,
            role_id: _role_id,
            tooltip: LF("{0} Settings\n{1}", [_role_label, L(_base_tool)]),
        });
    ...
    for (var i = 0; i <= obj_ini.companies; i++) {
        var _string = i == 0 ? L("Headquarters") : romanNumerals[i - 1] + " " + L("Company");
        var _button = new UnitButtonObject({
            style: "pixel",
            x1: _but_x,
            y1: _but_y,
    ...
    for (var i = 0; i < array_length(_role_order); i++) {
        ...
        array_push(_tog_buttons, {str1: _role_name, font: fnt_40k_14, tooltip: LF("activate to make {0}s a default member of your company command.", [L(_role_name)])});
    }
...
function scr_ui_settings() {
    ...
    if (menu != eMENU.SETTINGS) {
        ...
        draw_text_transformed(800, 66, string(global.chapter_name) + " " + L("Chapter Settings"), 1, 1, 0);
        draw_text_transformed(800, 110, L("(Codex Compliant)"), 0.6, 0.6, 0);
        ...
        _paint_shine.update({x1: 270, y1: _com_multi.y1 + 20});
        _paint_shine.draw();
        ...
        draw_text(937 - 341, 207, L("Battle Formations"));
        draw_text(937, 207, L("Company Settings"));
        draw_text(1278, 207, L("Astartes Role Settings"));
...
function setup_role_settings_buttons() {
    ...
    role_settings_ui.main_weapon_button = new UnitButtonObject({
        ...
        x1: _button_x,
        y1: 185,
        label: LF("Main Weapon: {0}", [L(obj_ini.wep1[100][_settings])]),
        set_width: true,
        w: 250,
        active: true,
    ...
    role_settings_ui.secondary_weapon_button = new UnitButtonObject({
        ...
        label: LF("Secondary Weapon: {0}", [L(obj_ini.wep2[100][_settings])]),
        set_width: true,
        w: 250,
        active: true,
    ...
    role_settings_ui.armour_button = new UnitButtonObject({
        ...
        label: LF("Armour: {0}", [L(obj_ini.armour[100][_settings])]),
        set_width: true,
        w: 250,
        active: true,
    ...
    role_settings_ui.gear_button = new UnitButtonObject({
        ...
        label: LF("Special Item: {0}", [L(obj_ini.gear[100][_settings])]),
        set_width: true,
        w: 250,
        active: true,
    ...
    role_settings_ui.mobi_button = new UnitButtonObject({
        ...
        label: LF("Mobility Item: {0}", [L(obj_ini.mobi[100][_settings])]),
        set_width: true,
        w: 250,
        active: true,
...
function scr_draw_mass_equip_gui() {
    if (total_role_number > 0) {
        ...
        draw_text_ext_transformed(107, 160, string_hash_to_newline(string(total_roles)), -1, 471 * 1.66, 0.9, 0.9, 0);

        var _roles_h = string_height_ext(string_hash_to_newline(string(total_roles)), -1, 471 * 1.66) * 0.9;
        draw_text_ext_transformed(107, 160 + _roles_h + 8, string_hash_to_newline(string(all_equip)), -1, 471 * 1.66, 0.9, 0.9, 0);
        ...
        draw_set_color(0);
        draw_text(333, 636, L("Requip All") + " " + L(obj_ini.role[100][role]) + " " + L("With Default Items"));
        ...
        if (req_wep1 != "") {
            ...
            if (req_wep1_num > have_wep1_num) {
                draw_text_transformed(154, 670, string_hash_to_newline("-" + L("Not enough") + " " + L(string(req_wep1)) + " (" + L("Have") + " " + string(have_wep1_num) + ", " + L("Need") + " " + string(req_wep1_num) + ")"), 0.6, 0.6, 0);
            }
            if (req_wep1_num <= have_wep1_num) {
                draw_text_transformed(154, 670, string_hash_to_newline("-" + L(string(req_wep1)) + " (" + L("Have") + " " + string(have_wep1_num) + ", " + L("Need") + " " + string(req_wep1_num) + ")"), 0.6, 0.6, 0);
            }
        }
        if (req_wep2 != "") {
            draw_set_color(c_gray);
            ...
            if (req_wep2_num > have_wep2_num) {
                draw_text_transformed(154, 698, string_hash_to_newline("-" + L("Not enough") + " " + L(string(req_wep2)) + " (" + L("Have") + " " + string(have_wep2_num) + ", " + L("Need") + " " + string(req_wep2_num) + ")"), 0.6, 0.6, 0);
            }
            if (req_wep2_num <= have_wep2_num) {
                draw_text_transformed(154, 698, string_hash_to_newline("-" + L(string(req_wep2)) + " (" + L("Have") + " " + string(have_wep2_num) + ", " + L("Need") + " " + string(req_wep2_num) + ")"), 0.6, 0.6, 0);
            }
        }
        if (req_armour != "") {
            draw_set_color(c_gray);
            ...
            if (req_armour_num > have_armour_num) {
                draw_text_transformed(154, 726, string_hash_to_newline("-" + L("Not enough") + " " + L(string(req_armour)) + " (" + L("Have") + " " + string(have_armour_num) + ", " + L("Need") + " " + string(req_armour_num) + ")"), 0.6, 0.6, 0);
            }
            if (req_armour_num <= have_armour_num) {
                draw_text_transformed(154, 726, string_hash_to_newline("-" + L(string(req_armour)) + " (" + L("Have") + " " + string(have_armour_num) + ", " + L("Need") + " " + string(req_armour_num) + ")"), 0.6, 0.6, 0);
            }
        }
        if (req_gear != "") {
            draw_set_color(c_gray);
            ...
            if (req_gear_num > have_gear_num) {
                draw_text_transformed(154, 754, string_hash_to_newline("-" + L("Not enough") + " " + L(string(req_gear)) + " (" + L("Have") + " " + string(have_gear_num) + ", " + L("Need") + " " + string(req_gear_num) + ")"), 0.6, 0.6, 0);
            }
            if (req_gear_num <= have_gear_num) {
                draw_text_transformed(154, 754, string_hash_to_newline("-" + L(string(req_gear)) + " (" + L("Have") + " " + string(have_gear_num) + ", " + L("Need") + " " + string(req_gear_num) + ")"), 0.6, 0.6, 0);
            }
        }
        if (req_mobi != "") {
            draw_set_color(c_gray);
            ...
            if (req_mobi_num > have_mobi_num) {
                draw_text_transformed(154, 782, string_hash_to_newline("-" + L("Not enough") + " " + L(string(req_mobi)) + " (" + L("Have") + " " + string(have_mobi_num) + ", " + L("Need") + " " + string(req_mobi_num) + ")"), 0.6, 0.6, 0);
            }
            if (req_mobi_num <= have_mobi_num) {
                draw_text_transformed(154, 782, string_hash_to_newline("-" + L(string(req_mobi)) + " (" + L("Have") + " " + string(have_mobi_num) + ", " + L("Need") + " " + string(req_mobi_num) + ")"), 0.6, 0.6, 0);
            }
        }
    }
    ...
    if (total_role_number > 0 && tab > -1) {
        ...
        draw_text_transformed(1203, 174, L("Select") + " " + slot_name, 0.6, 0.6, 0);
        draw_set_font(fnt_40k_14b);
        ...
        for (var h = 0; h < array_length(item_name); h++) {
            ...
            draw_text_transformed(x3, y3, L(item_name[h]), scale, 1, 0);
