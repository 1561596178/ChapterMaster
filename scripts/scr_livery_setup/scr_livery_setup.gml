...
function scr_livery_setup() {
    ...
    draw_text_color_simple(800, 74, chapter_name, CM_GREEN_COLOR);
    ...
    draw_text_transformed(580, 140, L("Battle Cry:"), 0.6, 0.6, 0);
    ...
    draw_set_halign(fa_center);
    if (_livery_type != 2) {
        var liv_string = LF("Full Livery \n{0}", [livery_picker.role_set == 0 ? L("default") : L(role[100][livery_picker.role_set])]);
        draw_text_transformed(160, 100, liv_string, 0.75, 0.75, 0);
    } else {
        draw_text_transformed(160, 100, L("Company Livery"), 0.75, 0.75, 0);
    }
