...
if (battle_special == "") {
    if (!dropping) {
        if (temp - dreadnoughts > 0) {
            if (variation == "") {
                p1 = L("Dirt crunches beneath the soles of ") + string(temp) + " " + string(global.chapter_name) + L(" as they form up.  Your ranks are made up of ");
            }
            if (variation == "rain") {
                p1 = L("Rain pelts the ground and fogs the air, partly veiling the ") + string(temp) + " " + string(global.chapter_name) + ".  Your ranks are made up of ";
            }
            if (variation == "dawn") {
                p1 = L("The bright light of dawn reflects off the ") + string_lower(color_descr) + L(" ceremite of ") + string(temp) + " " + string(global.chapter_name) + ".  Your ranks are made up of ";
            }
        }
    }
    if (dropping) {
        if (temp - dreadnoughts > 0) {
            // lyman
            p1 = L("The air rumbles and quakes as ") + string(temp) + " " + string(global.chapter_name) + L(" descend in drop-pods.  ");
        }
    }
}
...
if ((standard_bearers > 1) && (!dropping)) {
    p5 = L("  Chapter Ancients hold your Chapter heraldry high and proud.");
}

if (dreadnoughts + predators + land_raiders > 3) {
    p6 = L("  Forming up the armoured division is ");
    if (dreadnoughts == 1) {
...
if ((enemy == eFACTION.ORK) && (!dropping)) {
    rand = choose(1, 2, 3);
    if (rand < 4) {
        p1 = L("Howls and grunts ring from the surrounding terrain as the Orks announce their presence.  ");
...
if ((enemy == eFACTION.NECRONS) && (dropping == 0)) {
    rand = choose(1, 2, 3);
    if (rand < 4) {
        p1 = L("Dirt crunches beneath the feet of the Necrons as they make their silent advance.  ");
...
if ((temp >= 100) && (threat > 1) && (big_mofo > 0) && (big_mofo < 10) && !dropping) {
    ...
    if (global.chapter_name == "Salamanders") {
        ...
        if ((rand == 1) && (big_mofo != 1)) {
            p2 = L("breaks the silence, begining the Chapter Battlecry-");
        }
        if ((rand == 1) && (big_mofo == 1)) {
            p2 = L("break the silence, begining the Chapter Battlecry-");
        }
        if ((rand == 2) && (big_mofo != 1)) {
            p2 = L("roars the first half of the Chapter Battlecry-");
        }
        if ((rand == 2) && (big_mofo == 1)) {
            p2 = L("roar the first half of the Chapter Battlecry-");
        }
        if ((rand == 3) && (big_mofo != 1)) {
            p2 = L("shouts the start of the Chapter Battlecry-");
        }
        if ((rand == 3) && (big_mofo == 1)) {
            p2 = L("shout the start of the Chapter Battlecry-");
        }
        ...
        if ((rand == 5) && (big_mofo != 1)) {
            p2 = L("roars to your marines-");
        }
        if ((rand == 5) && (big_mofo == 1)) {
            p2 = L("roar to your marines-");
        }
    ...
    if (standard_cry == 0) {
        ...
        if (rand == 1) {
            ...
            p2 += L("the silence, calling out the Chapter Battlecry-");
        }
        if (rand == 2) {
            if (big_mofo != 1) {
                p2 = "roars ";
        ...
        p3 = "''" + string(L(obj_ini.battle_cry)) + "!''";
        if ((temp >= 100) && (temp < 200)) {
        ...
        if ((temp > 800) && (rand >= 3)) {
            p4 = L("The sound is deafening as the ") + string(global.chapter_name) + L(" add their voices.");
        }
        if ((temp > 800) && (rand <= 2)) {
