slate_panel.inside_method = function() {
    ...
    if (header == 3) {
        ...
        draw_text(x + (panel_width / 2), y + 89, string_hash_to_newline(L(title)));
        ...
        draw_set_font(fnt_cul_14);
        draw_text(x + (panel_width / 2), y + 20, string_hash_to_newline(L(title)));
        ...
        draw_sprite_stretched(spr_master_title, 0, x, y - 2, panel_width + 2, 4);
        draw_set_font(fnt_cul_14);
        draw_text(x + (panel_width / 2), y + 30, string_hash_to_newline(L(title)));
        draw_set_font(fnt_40k_12);
