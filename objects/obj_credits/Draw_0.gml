...
draw_text_transformed(172, 373, string_hash_to_newline(L("LEAD PROGRAMMERS")), 0.85, 0.85, 0);
draw_set_font(fnt_cul_14);
draw_text(172, 397, string_hash_to_newline("ZAB#Mystic#NelsonH#EttyKitty"));
draw_set_font(fnt_cul_18);
draw_text_transformed(172, 472, string_hash_to_newline(L("CONTRIBUTORS & SPECIAL THANKS")), 0.85, 0.85, 0);

draw_text(172, 526, string_hash_to_newline("vbcoder, Batat#Xorcon#IRC AFK'ers#/TG/"));

draw_text_transformed(492 - 100, 373, string_hash_to_newline(L("LEAD WRITERS")), 0.85, 0.85, 0);

draw_text(492 - 100, 397, string_hash_to_newline("Neddy#Nenjin#Pilz"));

draw_text_transformed(492 - 100, 472, string_hash_to_newline(L("ASSISTANT WRITERS")), 0.85, 0.85, 0);

draw_text(492 - 100, 498, string_hash_to_newline("Earthflame#Bludhawk#UCO Agent"));

draw_text_transformed(802 - 200, 373, string_hash_to_newline(L("LEAD ARTISTS")), 0.85, 0.85, 0);

draw_text(802 - 200, 397, string_hash_to_newline("Duke"));

draw_text_transformed(802 - 200, 472, string_hash_to_newline(L("ASSISTANT ARTISTS")), 0.85, 0.85, 0);

draw_text(802 - 200, 498, string_hash_to_newline("sinndogg#efngn#Toni ''TrashMan'' Stanicic"));

draw_text_transformed(802, 373, string_hash_to_newline(L("SUPPORTERS AND LEGACY CODERS")), 0.85, 0.85, 0);
