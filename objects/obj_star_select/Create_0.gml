...
colonist_button.update({tooltip: L("Planets with higher populations can provide more recruits both for your chapter and to keep a planets PDF bolstered, however colonists from other planets bring with them their home planets influences and evils /n REQ : 1000"), label: L("Request Colonists"), target: target});
...
recruiting_button.update({tooltip: L("Enable recruiting"), label: L("Recruiting"), target: target});
