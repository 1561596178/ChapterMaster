...
if (settings == 1) {
    ...
    draw_text_transformed(763, 149, L("Settings"), 1.5, 1.5, 0);

    draw_set_halign(fa_left);
    draw_set_font(fnt_cul_18);
    draw_text(493, 224, L("Master Volume"));
    draw_text(493, 281, L("Effects Volume"));
    draw_text(493, 339, L("Music Volume"));
    draw_text(493, 423, L("Full Screen?:"));
    draw_text(493, 483, L("Enable Autosaves?:"));
    ...
    draw_set_halign(fa_center);
    draw_set_font(fnt_cul_14);
    draw_text_transformed(929, 149, L("Menu"), 1.5, 1.5, 0);
}
